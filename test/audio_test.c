...
#define mic_volume_default	90		//unsure the value
#define inputBit_default	16		//unsure the value
#define gain_default		20		//unsure the value

#define outputRate_default	8*1000		//unsure the value
#define spk_volume_default	90		//unsure the value
#define outputBit_default	16		//unsure the value

#define buffer_total		10*1000

#define PCM_FRAME_BUF		320	//how to sure the size
